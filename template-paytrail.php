...
// =============================================================================
// TEMPLATE NAME: payment.paytrail
// -----------------------------------------------------------------------------
// Koodi osoitteesta: http://docs.paytrail.com/files/Paytrail_Module_Rest.zip
// 
// LOGIIKKA AIVAN TIEDOSTON LOPUSSA
// =============================================================================

$MERCHANTID = 'XXXX';
$MERCHANTSECRET = 'XXXX';

$MAKSU_MAKSETTU = 'https://vuokra.fit-technology.fi//kiitos/';
$MAKSU_KESKEYTETTY = 'https://vuokra.fit-technology.fi//kesken/';
$MAKSUN_ILMOITUS = 'https://vuokra.fit-technology.fi/'; //ei käytössä
...
// Luodaan maksu
$orderNumber = 	$entry_id;                     // Käytä yksikäsitteistä tilausnumeroa
$price = $entry[3];                         // Maksun summa (sis. alv)
...
try {
	...
	print_r($e);
    die("Virhe luotaessa maksua Paytrailin palveluun");
}
